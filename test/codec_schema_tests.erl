            ...
            data_type_definition = #opcua_structure{
                   ...
                   fields = [#opcua_field{
                             ...
                             #opcua_field{
                               ...
                               is_optional = false,
                               value = undefined}]}}},
    meck:expect(opcua_nodeset, node,
        fun(#opcua_node_id{value = 101}) -> StructureNode;
           (#opcua_node_id{value = 100}) -> InnerFieldNode end),
            ...
            data_type_definition = #opcua_structure{
                   ...
                   fields = [#opcua_field{
                             ...
                             #opcua_field{
                               ...
                               value = 1}]}}},
    meck:expect(opcua_nodeset, node,
        fun(#opcua_node_id{value = 101}) -> StructureNode end),
    NodeId = #opcua_node_id{type = numeric, value = 101},
...
enum() ->
    EnumNode = #opcua_node{
        node_id = #opcua_node_id{type = numeric, value = 101},
        node_class = #opcua_data_type{
            data_type_definition = #opcua_enum{
               node_id = #opcua_node_id{type = numeric, value = 101},
               fields = [#opcua_field{
                           tag = field_1,
                           value = 1},
                         #opcua_field{
                           ...
                           value = 2}]}}},
    meck:expect(opcua_nodeset, node,
        fun(#opcua_node_id{value = 101}) -> EnumNode end),
    NodeId = #opcua_node_id{type = numeric, value = 101},
    ToBeEncoded = field_2,
    assert_codec(NodeId, ToBeEncoded).

union() ->
    UnionNode = #opcua_node{
        node_id = #opcua_node_id{type = numeric, value = 101},
        node_class = #opcua_data_type{
            data_type_definition = #opcua_union{
                node_id = #opcua_node_id{type = numeric, value = 101},
                fields = [#opcua_field{
                            tag = some_integer,
                            node_id = #opcua_node_id{type = string, value = int32},
                          ...
                          #opcua_field{
                            ...
                            value = 2}]}}},
    meck:expect(opcua_nodeset, node,
        fun(#opcua_node_id{value = 101}) -> UnionNode end),
    NodeId = #opcua_node_id{type = numeric, value = 101},
    ToBeEncoded = #{some_string => <<"Hello!">>},
    assert_codec(NodeId, ToBeEncoded).

option_set() ->
    OptionSetNode = #opcua_node{
        node_id = #opcua_node_id{type = numeric, value = 101},
        node_class = #opcua_data_type{
            data_type_definition = #opcua_option_set{
                    node_id = #opcua_node_id{type = numeric, value = 101},
    ...
    meck:expect(opcua_nodeset, node,
        fun(#opcua_node_id{value = 101}) -> OptionSetNode end),
    NodeId = #opcua_node_id{type = numeric, value = 101},
    ToBeEncoded = [option_0, option_2],
    assert_codec(NodeId, ToBeEncoded).

builtin() ->
    BuiltinNode = #opcua_node{
        node_id = #opcua_node_id{type = numeric, value = 101},
        node_class = #opcua_data_type{
            data_type_definition = #opcua_builtin{
                node_id = #opcua_node_id{type = numeric, value = 101},
                builtin_node_id = #opcua_node_id{type = numeric, value = 6}}}},
    meck:expect(opcua_nodeset, node,
        fun(#opcua_node_id{value = 101}) -> BuiltinNode end),
    NodeId = #opcua_node_id{type = numeric, value = 101},
    ToBeEncoded = 123,
    assert_codec(NodeId, ToBeEncoded).
